    ...
    <main className="min-h-dvh bg-xuan pb-12 md:pb-16">
      ...
      <div className="mx-auto max-w-[1100px] px-4 pt-8 md:px-6 md:pt-12 space-y-8">
        ...
        <section className="rounded-2xl bg-surface/60 p-6 md:p-8">
          ...
          <div className="mt-6 border-t border-ink/8 pt-4">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full border border-ink/10 bg-xuan/30 px-4 py-2 min-h-[40px] font-serif text-xs text-muted transition-colors hover:border-ink/20 hover:text-light-ink active:scale-95"
            >
        ...
        <section className="rounded-2xl bg-surface/60 p-6 md:p-8">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 rounded-full bg-cinnabar px-5 py-2.5 min-h-[40px] font-serif text-sm text-white shadow-sm transition-all hover:bg-cinnabar/90 hover:shadow-md active:scale-95"
            >
            ...
            <button
              ...
              disabled={importing}
              className="inline-flex items-center gap-2 rounded-full bg-surface border border-ink/10 px-5 py-2.5 min-h-[40px] font-serif text-sm text-light-ink shadow-sm transition-all hover:bg-xuan-dark/30 hover:border-ink/20 active:scale-95 disabled:opacity-50"
            >
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
        ...
        <section className="rounded-2xl bg-surface/60 p-6 md:p-8">
          ...
          <button
            onClick={handleClear}
            className={`inline-flex items-center gap-2 rounded-full px-5 py-2.5 min-h-[40px] font-serif text-sm shadow-sm transition-all active:scale-95 ${
              clearStep === 0
