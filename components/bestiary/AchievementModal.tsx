  ...
  const content = (
    ...
    >
      ...
      >
        ...
        {/* Trophy icon with pop animation instead of infinite bounce */}
        <div className="relative mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-gold to-amber-600 text-white shadow-lg animate-trophy-pop">
        ...
        <p className="mt-1 font-handwrite text-sm text-cinnabar animate-fade-in" style={{ animationDelay: "0.45s", animationFillMode: "both" }}>
          "博物君子，通识万物"
        </p>
