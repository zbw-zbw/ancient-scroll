...
export default function PlaceholderPage({ title, subtitle }: PlaceholderPageProps) {
 ...
 <Link
        href="/"
        className="inline-flex items-center gap-2 rounded-full bg-seal-bg px-6 py-2 font-serif text-sm text-cinnabar transition-colors hover:bg-cinnabar hover:text-surface"
      >
        <IconArrowLeft className="h-3.5 w-3.5" /> 返回首页
      </Link>
 </div>
 </main>
 </>
