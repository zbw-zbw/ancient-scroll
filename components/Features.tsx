...
function BestiaryMockup() {
 ...
 className={`absolute w-44 rounded-xl bg-surface p-3 shadow-lg transition-all duration-300 hover:scale-105 hover:z-50 active:scale-105 ${
...
function PoetryMockup() {
 ...
 return (
 <div className="rounded-2xl bg-surface p-4 md:p-6 shadow-lg">
...
function DialogueMockup() {
 ...
 <div className="mt-4 rounded-full bg-xuan px-4 py-2">
