...
export default function EndingSlide({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative z-10 mx-auto max-w-2xl px-6 pb-24 text-center transition-all duration-1000 md:pb-16 ${
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:flex-wrap">
          ...
          />
          <button
            onClick={() => readFullPoem(poem.lines.map((l) => l.text).join("，"))}
