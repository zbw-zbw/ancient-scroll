export default function Footer() {
 ...
 <div className="mt-8 inline-flex items-center gap-2 rounded-full bg-surface/60 px-4 py-1.5">
 ...
 <div
        className="flex h-24 w-24 items-center justify-center rounded-sm bg-seal-bg rotate-[-3deg] shadow-sm"
      >
