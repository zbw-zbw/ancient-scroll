...
export default function ChapterSidebar({
  ...
  return (
    <>
      ...
      <aside className="hidden md:fixed md:left-0 md:top-16 md:h-[calc(100dvh-4rem)] md:w-[200px] lg:w-[240px] md:flex md:flex-col md:overflow-hidden md:bg-xuan-dark">
